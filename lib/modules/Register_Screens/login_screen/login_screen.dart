...
import 'package:ecommerce/modules/Register_Screens/login_screen/cubit/cubit.dart';
import 'package:ecommerce/modules/Register_Screens/login_screen/cubit/state.dart';
import 'package:ecommerce/modules/Register_Screens/signup_screen/signup_screen.dart';
        ...
        child: BlocConsumer<LoginCubit, LogInStates>(
          ...
          if (state is LoginSuccessState) {
            if (state.userDateModel.status) {
              showError(
                  massage: state.userDateModel.message,
                  state: ToastState.SUCCESS,
                  gravity: ToastGravity.BOTTOM,
                  toastLength: Toast.LENGTH_LONG);
              CacheHelper.saveDate(
                      key: 'token', value: state.userDateModel.data.token)
                  .then((value) {

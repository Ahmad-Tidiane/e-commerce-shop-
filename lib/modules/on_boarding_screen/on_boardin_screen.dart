...
import 'package:ecommerce/modules/Register_Screens/welcome_screen/welcome_screen.dart';
...
class _OnBoardinScreenState extends State<OnBoardinScreen> {
  ...
  void Onsubmit() {
    CacheHelper.saveDate(key: 'onBoarding', value: true).then(
        (value) => NavigateAndFinsh(router: WelcomeScreen(), context: context));
  }
